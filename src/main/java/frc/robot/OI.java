...
import frc.robot.commands.subsystems.manipulator.climber.TestClimber;
...
public class OI {
    public static XboxController xboxController = new XboxController(0)
           ...
           // .whileHeld(XboxController.Button.A, new AimLock())
            ...
            .whenPressed(XboxController.Button.B, new TestClimber(0.5))
            .whenReleased(XboxController.Button.B, new TestClimber(0))
            .whenPressed(XboxController.Button.X, new TestClimber(-0.5))
            .whenReleased(XboxController.Button.X, new TestClimber(0));
