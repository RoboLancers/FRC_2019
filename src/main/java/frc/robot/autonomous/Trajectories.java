...
public class Trajectories {
    ...
    public static final class ROCKET {
        public static final class LEFT {
            ...
            private static final Pose2d ROCKET_TURN_FACING_RIGHT = new Pose2d(LengthKt.getFeet(8), LengthKt.getFeet(25), Rotation2dKt.getDegree(0));
            private static final Pose2d ROCKET_TURN_FACING_LEFT = new Pose2d(LengthKt.getFeet(8), LengthKt.getFeet(25), Rotation2dKt.getDegree(180));
            ...
            public static TimedTrajectory<Pose2dWithCurvature> leftNearRocketToLeftTurn = generateTrajectory(Arrays.asList(
                    ROCKET_NEAR_HATCH,
                    ROCKET_TURN_FACING_RIGHT
            ), true);

            // 180 degree turn here

            public static TimedTrajectory<Pose2dWithCurvature> leftTurnToLeftLoadingStation = generateTrajectory(Arrays.asList(
                    ROCKET_TURN_FACING_LEFT,
                    LOADING_STATION_LEFT_PICKUP
            ));
        }
        ...
        public static final class RIGHT {
            ...
            private static final Pose2d RIGHT_ROCKET_TURN_FACING_RIGHT = new Pose2d(LengthKt.getFeet(8), LengthKt.getFeet(2), Rotation2dKt.getDegree(0));
            private static final Pose2d RIGHT_ROCKET_TURN_FACING_LEFT = new Pose2d(LengthKt.getFeet(8), LengthKt.getFeet(2), Rotation2dKt.getDegree(180));
            ...
            public static TimedTrajectory<Pose2dWithCurvature> rightNearRocketToRightTurn = generateTrajectory(Arrays.asList(
                    RIGHT_ROCKET_NEAR_HATCH,
                    RIGHT_ROCKET_TURN_FACING_RIGHT
            ), true);

            // 180 degree turn here

            public static TimedTrajectory<Pose2dWithCurvature> rightTurnToRightLoadingStation = generateTrajectory(Arrays.asList(
                    RIGHT_ROCKET_TURN_FACING_LEFT,
                    LOADING_STATION_RIGHT_PICKUP
            ));
        }
    }
